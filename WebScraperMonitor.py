...
while True:
    ...
    if info is None:
        ...
        """
            the URL is checked for every 1 hour whether the content has been posted onto that particular URL or not
            (You can also change the sleep time to whatever you want to)
        """
        time.sleep(3600)
    # The moment the content is posted on the URL The content is parsed from the URL and is written to a TEXT file
    else:
